...
c -----------------------------------------------------------
     ...
     +         stat=80,  equal=1,   mx_st=50,samp_inv=90,samp_ori=100)
      integer available
...
c        -----------------------------
     ...
     +                   (n,is(iu),is(ju),is(iju),is(u),is(d),is(work1))
            ...
            st(12)=st(12)+1
c        ---------------------------
         elseif (option.eq.samp_inv) then
c        ---------------------------
            work1  = even(u     + maxu*ratio)
            needed = work1 + n*ratio
            t0=second()
            ...
            call s_inv
     +              (n,is(iu),is(ju),is(iju),is(u),is(d),is(work1),tol)
            call permute (n,is(work1),b,is(perm))
c        ---------------------------	  
	 elseif (option .eq. samp_ori) then
c        ---------------------------
            work1  = even(u     + maxu*ratio)
	    work2  = even(work1 + n*ratio)
	    needed = even(work2 + n*ratio)       
     ...
     +              (n,is(iu),is(ju),is(iju),is(u),is(d),is(work1),
     +               is(work2),tol)
            call permute (n,is(work2),b,is(perm))	  
